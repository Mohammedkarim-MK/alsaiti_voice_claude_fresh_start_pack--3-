...
const A_FACETS = [
  ['#37E39C', '50,6 46,32 54,32'],
  ['#22C888', '50,6 37,29 46,32'],
  ['#22C888', '37,29 46,32 40,57'],
  ['#15AC72', '37,29 40,57 22,57'],
  ['#0D8C5D', '22,57 40,57 37,68'],
  ['#0A6E4A', '22,57 37,68 33,87'],
  ['#075336', '22,57 33,87 6,87'],
  ['#22C888', '50,6 63,26 54,32'],
  ['#15AC72', '63,26 54,32 61,54'],
  ['#0D8C5D', '63,26 61,54 80,57'],
  ['#0D8C5D', '80,57 61,54 62,66'],
  ['#0A6E4A', '80,57 62,66 64,87'],
  ['#075336', '80,57 64,87 93,87'],
  ['#E6C34E', '40,57 61,54 62,66'],
  ['#E6C34E', '40,57 62,66 37,68'],
  ['#C79A32', '37,68 62,66 54,80'],
];
function ALogo({ size = 34 }) {
  return (
    <Svg width={size} height={size * (92 / 100)} viewBox="0 0 100 92">
      {A_FACETS.map((f, i) => (
