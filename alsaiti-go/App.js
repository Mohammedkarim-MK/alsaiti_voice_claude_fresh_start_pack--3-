...
/* The ALSAITI brand mark, traced facet-by-facet from the identity sheet, in the lifted
   palette the dark app background needs (the sheet's own forest greens vanish on it). */
const A_FACETS = [
  { p: '80,11.8 122.3,12.7 99.9,61.1', a: '#4ebc7f', b: '#64ba88', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '75.7,19 71.8,76.8 35.5,105.8', a: '#398f61', b: '#42ab71', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '30.1,113.1 67.6,84.3 35.2,154.8', a: '#2a7b47', b: '#2c8357', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '78.7,17.4 99.1,63.4 97.2,66.9 73.4,74.7', a: '#52b278', b: '#53b880', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '125.8,19 158.2,90.3 129,67.6', a: '#68b082', b: '#75bd91', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '173.1,117.4 198,169.1 197.8,173.1 167.3,159.9', a: '#4fb779', b: '#5db484', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '2,172.3 28.3,117.4 33.9,160.4', a: '#2e7146', b: '#2a7f50', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '101.9,65.3 122.7,16.6 127.9,67.1', a: '#46aa75', b: '#61b884', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '144.8,123.4 169.5,108.2 171.6,116.2 165.2,155.6', a: '#57b37d', b: '#68b988', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '56.4,112.1 72.5,82.5 79.1,115.6 60.8,130.8 56.1,120.2', a: '#338256', b: '#3d9864', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '35.6,161.7 48.7,187.4 4.5,175.7', a: '#2d6c43', b: '#298353', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '77.5,74.2 99.6,66.7 79.6,113.8 72.8,79.6', a: '#4b9e69', b: '#42b079', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '167.6,160.8 197,175.7 152.8,188.2', a: '#31754d', b: '#2f8d5f', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '62.6,133.5 79.4,117.4 89.8,143.9 67.3,148.4', a: '#3d9f70', b: '#5eb380', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '65.6,154.4 49.5,185.8 37.2,161', a: '#27794c', b: '#308154', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '135.1,152.8 165.1,161.9 150.4,185.8', a: '#308156', b: '#308156', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '164.4,108.7 144.1,122.9 110.7,107.9', a: '#72b48b', b: '#72be8d', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '104.2,107 138.8,124 103.2,126.9', a: '#459768', b: '#4ea36e', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '135.5,146.3 145.7,126.6 162.5,158 136.5,150.9', a: '#38835a', b: '#379262', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '115.6,147.1 128.4,126.7 142.3,126.4 133.8,150.1', a: '#378b5e', b: '#3c9867', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '69.7,149.6 90.6,144.6 98.8,167.6', a: '#9ea04a', b: '#bfaf54', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '108.3,79.4 128.7,68.7 130.3,93.4', a: '#cdb46d', b: '#d4be82', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '133.4,93.6 136.3,75 159.7,93.3', a: '#cab05d', b: '#f1dea7', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '100.7,65.6 116.2,67.8 111.6,77.1 93.3,86.2', a: '#cfb061', b: '#ecdaa2', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '98.5,144.6 113.9,147.8 100.5,166.5 94.4,153.1', a: '#ceb97e', b: '#f0dba2', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '55.4,119.7 60.6,133.4 40.1,153', a: '#3e7d52', b: '#40996a', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '62,136.1 66.8,149.6 41.2,157.1', a: '#3a8357', b: '#409166', x1: 0, y1: 0, x2: 0, y2: 0 },
  { p: '114.9,147.7 131.1,152 106.4,165.1', a: '#388d5a', b: '#478f61', x1: 0, y1: 0, x2: 0, y2: 0 },
];
