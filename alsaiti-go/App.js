...
const A_FACETS = [
  ['#37E39C', '48,6 44,32 53,32'],
  ['#22C888', '48,6 35,30 44,32'],
  ['#22C888', '35,30 44,32 39,58'],
  ['#15AC72', '35,30 39,58 20,58'],
  ['#0D8C5D', '20,58 39,58 36,70'],
  ['#0A6E4A', '20,58 36,70 32,90'],
  ['#075336', '20,58 32,90 6,90'],
  ['#E6C34E', '39,58 57,55 56,69'],
  ['#E6C34E', '39,58 56,69 36,70'],
  ['#C79A32', '36,70 56,69 49,82'],
  ['#E6C34E', '57,55 57,55 65,65'],
  ['#C79A32', '57,55 65,65 56,69'],
  ['#22C888', '48,6 62,27 53,32'],
  ['#15AC72', '62,27 53,32 64,45'],
  ['#15AC72', '62,27 64,45 85,49'],
  ['#0D8C5D', '85,49 64,45 75,55'],
  ['#0D8C5D', '85,49 75,55 79,79'],
  ['#0A6E4A', '79,79 75,55 65,65'],
  ['#0A6E4A', '79,79 65,65 60,90'],
  ['#075336', '79,79 60,90 90,90'],
];
function ALogo({ size = 34 }) {
  return (
    <Svg width={size} height={size * (94 / 102)} viewBox="0 0 102 94">
      {A_FACETS.map((f, i) => (
